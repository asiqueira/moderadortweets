...
db.run('CREATE TABLE IF NOT EXISTS tweets (id_tweet INTEGER PRIMARY KEY, nm_screen_name TEXT NULL, nm_url_imagem TEXT NULL, tx_mensagem TEXT NULL, nm_status TEXT NULL)');
